...
export const experience = [
  {
    ...
    period: "Current",
    responsibilities: [
      "Develop and maintain full-stack web applications using React, Next.js, TypeScript, Node.js, and Express.js.",
      "Build cross-platform mobile applications with React Native, delivering consistent experiences across Android and iOS.",
      "Design and integrate REST APIs, optimize application performance, and collaborate with cross-functional teams to deliver production-ready features.",
    ],
    achievements: [
      "Delivered production-ready web and mobile features that improved user experience, performance, and development efficiency.",
      "Contributed across the entire product lifecycle, from frontend interfaces and backend services to mobile application development and deployment.",
    ],
    tech: [
      "JavaScript",
      "TypeScript",
...
export const profile = {
  ...
  bio: "Full Stack & React Native Developer with 1+ year of experience crafting modern web and mobile experiences. Passionate about clean architecture, intuitive user interfaces, and AI-assisted engineering, I build fast, scalable products that turn ambitious ideas into production-ready solutions.",
};
