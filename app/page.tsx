...
export default function Home() {
  ...
  const shouldRenderMobile = width === null || width < 900;
  const shouldRenderDesktop = width === null || width >= 900;

  return (
    <>
      {/* Mobile screen block overlay */}
      {shouldRenderMobile && (
        <div className="mobile-only-flex w-screen h-screen bg-space-black items-center justify-center p-6 text-frost overflow-hidden font-body relative z-[100]">
          ...
          <div className="glass-strong rounded-3xl p-8 md:p-10 max-w-md w-full text-center border border-white/10 flex flex-col items-center gap-6 relative z-10 shadow-2xl">
            ...
            <div className="w-full grid grid-cols-2 gap-4 pt-6 border-t border-white/10 font-mono text-xs">
              <div className="glass rounded-xl p-4 flex flex-col items-center border border-white/5">
                ...
                <span className="text-aqua font-600 text-base">{width !== null ? `${width}px` : "Detecting..."}</span>
              </div>
              <div className="glass rounded-xl p-4 flex flex-col items-center border border-white/5">
                <span className="text-[10px] text-soft-gray/60 uppercase tracking-widest mb-1.5">
                  Required Width
      ...
      {/* Desktop experience */}
      {shouldRenderDesktop && (
        <main className="desktop-only-block relative w-screen h-screen overflow-hidden">
